...
with st.sidebar:
    ...
    if selected_group == "기본":
        default_tickers = "RKLB, ASTS, APP, SLDP, QS, NEE, FLNC, EOSE, CCJ, SMR, CEG, VST, OKLO, ORCL, APLD, AIRO, CIFR, NBIS, RGTI, QBTS, IONQ, CRCL, BITI, SOFI, SHOP, COIN, HOOD, TSM, AMD, MU, PLTR, GOOGL, TSLA, META, AVGO, AMZN, MSFT, NVDA"
    else:
